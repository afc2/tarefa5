...
public class BuildSymbolTableVisitor implements IVisitor<Void> {
	...
	public Void visit(MainClass n) {
		...
		currClass.getMethod("main").addParam(n.i2.toString(), new IntArrayType());
		n.i1.accept(this);
		n.i2.accept(this);
		n.s.accept(this);
		return null;
	...
	public Void visit(VarDecl n) {
		...
		if (currMethod == null) {
			if(!currClass.addVar(n.i.toString(),n.t)){
				System.err.println("Variável " + n.i.toString() + 
						" já está declarada na classe " + currClass.getId());
			}
		} else {
			if(!currMethod.addVar(n.i.toString(), n.t)){
				System.err.println("Variável " + n.i.toString() + 
						" já está declarada no método " + currMethod.getId());
			}
		}		
